...
//        try {
//            BufferedReader br = new BufferedReader(new FileReader("GITHUB_TOKEN"));
//            this.accessToken = "token " + br.readLine();
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
    ...
    public List<PullRequest> getPullRequests(String owner, String repoName) throws IOException {
        Call<List<PullRequest>> retrofitCall = service.listPullRequests(accessToken, API_VERSION_SPEC, owner, repoName);
